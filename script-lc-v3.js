...
const translations = {
  es: {
    ...
    'portfolio.intro': 'Propuestas web y proyectos en desarrollo que acompañan mi aprendizaje.',
    'portfolio.invictusStatus': 'PROPUESTA / DEMO',
    'portfolio.invictusDescription': 'Propuesta de página web para un gimnasio: presentación, equipamiento, entrenadores, planes, horarios y contacto. Pendiente de aprobación.',
    'portfolio.viewDemo': 'Ver propuesta ↗',
  ...
  en: {
    ...
    'portfolio.intro': 'Website proposals and projects in progress that support my learning.',
    'portfolio.invictusStatus': 'PROPOSAL / DEMO',
    'portfolio.invictusDescription': 'A proposed gym website featuring an introduction, equipment, trainers, plans, opening hours and contact information. Awaiting approval.',
    'portfolio.viewDemo': 'View proposal ↗',
